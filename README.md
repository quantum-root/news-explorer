...
- Modern desktop interface built with Flet
- RSS-based live news fetching
- Multiple news sources
- Open articles directly in browser
- Dark mode interface
...
- 👤 **Mehmet Tuncer** - [GitHub Profile](https://github.com/quantum-root)
- 👤 **Fatih Buğra Yılmazgil** - [GitHub Profile](fatihbugrayilmazgil)
